                ...
                <div class="md:grid md:grid-cols-12 md:gap-12 lg:gap-20 items-center">
                    ...
                    <div class="md:col-span-5 lg:col-span-5 text-center md:text-right" x-data="{ modalExpanded: false }"
                        ...
                        <div class="inline-flex relative justify-center items-center">
                            ...
                            <img class="absolute" src="{{ asset('images/desarrollo-web.jpg') }}" width="290"
                            ...
                            <img class="relative max-w-full mx-auto md:mr-0 md:max-w-none h-auto pointer-events-none"
                                src="{{ asset('images/iphone-mockup.png') }}" width="344" height="674"
                            ...
                            <a class="absolute hover:opacity-75 transition cursor-pointer duration-150 ease-in-out"
                                ...
                                <img src="{{ asset('images/play-button.svg') }}" width="96" height="96"
                                    alt="Botón de inicio" />
                            </a>
                        </div>
                        <!-- Modal backdrop -->
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide max-w-lg">
                        <img class="transition-opacity duration-300 object-cover object-center"
                            src="{{ asset('images/cursos.jpg') }}" width="540" height="460"
                    ...
                    <div class="swiper-slide max-w-lg">
                        <img class="transition-opacity duration-300" src="{{ asset('images/simple.jpg') }}"
                    ...
                    <div class="swiper-slide max-w-lg">
                        <img class="transition-opacity duration-300" src="{{ asset('images/appy.jpg') }}"
                    ...
                    <div class="swiper-slide max-w-lg">
                        <img class="transition-opacity duration-300" src="{{ asset('images/curso-inicio.jpg') }}"
                    ...
                    <div class="swiper-slide max-w-lg">
                        <img class="transition-opacity duration-300" src="{{ asset('images/admin.png') }}"
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div x-show="['1'].includes(category)">
                                    <div class="relative" data-aos="fade-up">
                                        <img class="w-full" src="{{ asset('images/ecommerce.jpg') }}" width="352"
                                ...
                                <div x-show="['1'].includes(category)">
                                    <div class="relative flex justify-center items-center" data-aos="fade-up">
                                        <img class="w-full" src="{{ asset('images/ecommerce1.jpg') }}" width="352"
                                            height="264" alt="ecommerce" />
                                    </div>
                                </div>
                                <div x-show="['1'].includes(category)">
                                    <div class="relative flex justify-center items-center shadow" data-aos="fade-up">
                                        <img class="w-full" src="{{ asset('images/ecommerce2.jpg') }}"
                                ...
                                <div x-show="['1'].includes(category)">
                                    <div class="relative flex justify-center items-center shadow" data-aos="fade-up">
                                        <img class="w-full" src="{{ asset('images/ecommerce3.jpg') }}"
                                            width="352" height="264" alt="ecommerce" />
                                ...
                                <div x-show="['2'].includes(category)">
                                    <div class="relative flex justify-center items-center shadow" data-aos="fade-up">
                                        <img class="w-full" src="{{ asset('images/courses.jpg') }}" width="352"
                                ...
                                <div x-show="['2'].includes(category)">
                                    <div class="relative flex justify-center items-center shadow" data-aos="fade-up">
                                        <img class="w-full" src="{{ asset('images/courses2.jpg') }}" width="352"
                                            height="264" alt="Cursos en línea" />
                                ...
                                <div x-show="['2'].includes(category)">
                                    <div class="relative flex justify-center items-center shadow" data-aos="fade-up">
                                        <img class="w-full" src="{{ asset('images/courses3.jpg') }}" width="352"
                                            height="264" alt="Cursos en línea" />
                                ...
                                <div x-show="['3'].includes(category)">
                                    <div class="relative flex justify-center items-center shadow" data-aos="fade-up">
                                        <img class="w-full" src="{{ asset('images/blog.jpg') }}" width="352"
                                            height="264" alt="blog" />
                                ...
                                <div x-show="['3'].includes(category)">
                                    <div class="relative flex justify-center items-center shadow" data-aos="fade-up">
                                        <img class="w-full" src="{{ asset('images/blog2.jpg') }}" width="352"
                                            height="264" alt="blog" />
                                ...
                                <div x-show="['3'].includes(category)">
                                    <div class="relative flex justify-center items-center shadow" data-aos="fade-up">
                                        <img class="w-full" src="{{ asset('images/blog3.jpg') }}" width="352"
                                            height="264" alt="blog" />
                                ...
                                <div x-show="['4'].includes(category)">
                                    <div class="relative flex justify-center items-center shadow" data-aos="fade-up">
                                        <img class="w-full" src="{{ asset('images/simple.jpg') }}" width="352"
                                ...
                                <div x-show="['4'].includes(category)">
                                    <div class="relative flex justify-center items-center shadow" data-aos="fade-up">
                                        <img class="w-full" src="{{ asset('images/appy.jpg') }}" width="352"
                                            height="264" alt="plantilla web appy" />
                                    </div>
                                </div>
                                <div x-show="['4'].includes(category)">
                                    <div class="relative flex justify-center items-center shadow" data-aos="fade-up">
                                        <img class="w-full" src="{{ asset('images/tidy.jpg') }}" width="352"
                                            height="264" alt="plantilla web tidy" />
                                    </div>
                                </div>
                                <div x-show="['4'].includes(category)">
                                    <div class="relative flex justify-center items-center shadow" data-aos="fade-up">
                                        <img class="w-full" src="{{ asset('images/open.jpg') }}" width="352"
            ...
            <div class="py-12 md:py-20 border-t border-gray-200 dark:border-gray-800">
                ...
                <div
                    ...
                    <div class="relative flex flex-col items-center">
                        ...
                        <div class="inline-flex relative justify-center items-center">
                            <!-- Image inside mockup size: 290x624px (or 580x1248px for Retina devices) -->
                            <img class="absolute" src="{{ asset('images/responsive.jpg') }}" width="290"
                    ...
                    <div class="relative flex flex-col items-center">
                        ...
                        <div class="inline-flex relative justify-center items-center">
                            ...
                            <img class="absolute object-cover object-center"
                                src="{{ asset('images/responsive2.jpg') }}" width="290" height="624"
                    ...
                    <div class="relative flex flex-col items-center">
                        ...
                        <div class="inline-flex relative justify-center items-center">
                            <!-- Image inside mockup size: 290x624px (or 580x1248px for Retina devices) -->
                            <img class="absolute" src="{{ asset('images/responsive3.jpg') }}"" width="290"
                    ...
                    <div class="flex flex-col h-full p-6 bg-white dark:bg-gray-800 shadow" data-aos="fade-down">
                        <div class="grow mb-4 pb-4">
                            <div class="flex justify-between items-center mb-1">
                                ...
                                {{-- <div
                                    class="inline-flex px-3 py-1 text-xs font-medium text-teal-600 dark:text-teal-400 bg-teal-200 dark:bg-teal-600 dark:bg-opacity-25 rounded-full">
                                    -40%</div> --}}
                            </div>
                        ...
                        <div class="mt-24">
                            <a class="btn-sm text-white bg-purple-500 hover:bg-purple-400 dark:text-teal-400 dark:bg-gray-700 dark:hover:bg-gray-600 w-full"
                                href="{{ route('home.services') }}">Ver más</a>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <div class="text-center">
                        <div class="relative inline-flex flex-col mb-4">
                            <img class="rounded-full" src="{{ asset('images/testimonial-01.jpg') }}" width="56"
                    ...
                    <div class="text-center">
                        <div class="relative inline-flex flex-col mb-4">
                            <img class="rounded-full" src="{{ asset('images/testimonial-02.jpg') }}" width="56"
                    ...
                    <div class="text-center">
                        <div class="relative inline-flex flex-col mb-4">
                            <img class="rounded-full" src="{{ asset('images/testimonial-03.jpg') }}" width="56"
