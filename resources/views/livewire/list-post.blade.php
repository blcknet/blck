    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                <!-- Add customer button -->
                <a href="{{ route('posts.create') }}" class="btn bg-indigo-500 hover:bg-indigo-600 text-white">
        ...
        <div class="bg-white shadow-lg rounded-sm border border-slate-200">
            <header class="px-5 py-4">
                <h2 class="font-semibold text-slate-800">Todos los posts <span
                        class="text-slate-400 font-medium">{{ $posts->count() }}</span></h2>
            </header>
                            ...
                            <tbody class="text-sm divide-y divide-slate-200">
                                @foreach ($posts as $post)
                                    ...
                                    <tr>
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                            <div class="flex items-center">
                                                <label class="inline-flex">
                                                    ...
                                                    <input class="table-item form-checkbox" value={{ $post->id }}
                                        ...
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                            <div class="text-left">{{ Str::limit($post->extract, 25) }}</div>
                                        </td>
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                            <div class="text-left">{!! Str::limit($post->body, 25) !!}</div>
                                        </td>
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                        ...
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                            <div class="text-left font-medium text-sky-500">
                                                @isset($post->category->name)
                                                    {{ Str::limit($post->category->name, 10) }}
                                                @else
                                                    No especificado
                                                @endisset
                                            </div>
