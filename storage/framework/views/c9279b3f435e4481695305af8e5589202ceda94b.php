...
<head>
    ...
    <meta name="keywords"
        content="desarrollo web en México, diseño web a medida, desarrollo web en cuautitlan, blcknet desarrollo web, desarrollo de sitios web a medida, desarrollo de aplicaciones web, página web a medida, desarrollo de paginas web, diseño de páginas web en México, posicionamiento seo">
    <?php echo e($head); ?>

    <title><?php echo $__env->yieldContent('title'); ?></title>
    <link rel="icon" href="<?php echo e(asset('images/logo-ico.ico')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('build/assets/app.1bd1f369.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('build/assets/style.222c08bc.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('build/assets/style2.ebaca14f.css')); ?>">
...
<body class="font-inter antialiased bg-white text-gray-900 dark:bg-gray-900 dark:text-gray-100 tracking-tight">
                ...
                <div class="flex items-center justify-between h-20">
                    ...
                    <div class="shrink-0 mr-5">
                        ...
                        <a class="block text-sm bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-teal-100"
                            href="<?php echo e(route('home.index')); ?>" aria-label="Cruip">
                            <img id="logo" class="h-24 w-24" src="<?php echo e(asset('images/logo-blanco.png')); ?>"
                        ...
                        <ul class="flex grow flex-wrap items-center font-medium">
                            <li>
                                <a class="text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 px-5 py-2 flex items-center transition duration-150 ease-in-out"
                                    href="<?php echo e(route('home.services')); ?>">Servicios</a>
                            </li>
                            <li>
                                <a class="text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 px-5 py-2 flex items-center transition duration-150 ease-in-out"
                            ...
                            <li>
                                <a class="text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 px-5 py-2 flex items-center transition duration-150 ease-in-out"
                                    href="<?php echo e(route('home.about')); ?>">Nosotros</a>
                            </li>
                        </ul>
                        ...
                        <nav id="mobile-nav"
                            ...
                            <div class="py-6 pr-4 pl-20">
                                ...
                                <div class="shrink-0 mr-5">
                                    ...
                                    <a class="block text-sm bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-teal-100"
                                        href="<?php echo e(route('home.index')); ?>" aria-label="Cruip">
                                        <img id="logo-mobile" class="h-16 w-16"
                                            src="<?php echo e(asset('/images/logo.png')); ?>" alt="Logo blcknet.com">
                                    </a>
                                </div>
                                <!-- Links -->
                                <ul>
                ...
                <div class="py-12 md:py-16 border-t border-gray-200 dark:border-gray-800 -mt-px">
                    ...
                    <div class="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
                        ...
                        <div class="md:col-span-2 lg:col-span-3">
                            <!-- Logo -->
                            <a class="inline-block" href="<?php echo e(route('home.index')); ?>" aria-label="Cruip">
                                <img id="logo-footer" class="h-36 w-36 object-center object-cover"
                                    src="<?php echo e(asset('images/logo-negro-blck.png')); ?>" alt="Logo largo blcknet">
                            </a>
                        </div>
                                ...
                                <ul>
                                    <li class="mb-1">
                                        <a class="text-gray-600 dark:text-gray-400 hover:underline transition duration-150 ease-in-out"
                                            href="<?php echo e(route('home.services')); ?>">Landing Page</a>
                                    </li>
                                    <li class="mb-1">
                                        <a class="text-gray-600 dark:text-gray-400 hover:underline transition duration-150 ease-in-out"
                                            href="<?php echo e(route('home.services')); ?>">Sitio Informativo</a>
                                    </li>
                                    <li class="mb-1">
                                        <a class="text-gray-600 dark:text-gray-400 hover:underline transition duration-150 ease-in-out"
                                            href="<?php echo e(route('home.services')); ?>">Tienda en Línea</a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="md:flex md:items-center md:justify-between">
                        ...
                        <div class="text-sm md:order-1 text-gray-700 mb-2 md:mb-0 text-center">
                            <a class="text-gray-600 dark:text-gray-400 hover:underline transition duration-150 ease-in-out"
                                href="<?php echo e(route('home.privacy')); ?>" rel="nofollow">Politica de privacidad.</a>
                        </div>
    ...
    <script src="<?php echo e(asset('build/assets/app.ab93cf8a.js')); ?>"></script>

</body>

</html>
<?php /**PATH C:\laragon\www\blckweb\resources\views/layouts/guest.blade.php ENDPATH**/ ?>