...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('build/assets/style-mosaic.e1632fd2.css')); ?>">
        ...
        <div>
            ...
            <div id="sidebar"
                ...
                <div class="mb-10 pr-3 sm:px-2">
                    ...
                    <!-- Logo -->
                    <a class="block py-3" href="<?php echo e(route('home.index')); ?>">
                        <div class="gap-x-3">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="relative inline-flex" x-data="{ open: false }">
                                <button class="inline-flex justify-center items-center group" aria-haspopup="true"
                                    ...
                                    <img class="w-8 h-8 rounded-full" src="<?php echo e(auth()->user()->profile_photo_url); ?>"
                                        width="32" height="32" alt="<?php echo e(auth()->user()->name); ?>" />
                                    <div class="flex items-center truncate">
                                        <span
                                            class="truncate ml-2 text-sm font-medium group-hover:text-slate-800"><?php echo e(auth()->user()->name); ?></span>
                                        <svg class="w-3 h-3 shrink-0 ml-1 fill-current text-slate-400"
                                            viewBox="0 0 12 12">
                                            <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z" />
                                        </svg>
...
<?php /**PATH C:\laragon\www\blckweb\resources\views/layouts/app.blade.php ENDPATH**/ ?>