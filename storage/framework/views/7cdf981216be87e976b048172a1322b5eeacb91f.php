    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                <!-- Add customer button -->
                <a href="<?php echo e(route('roles.create')); ?>" class="btn bg-indigo-500 hover:bg-indigo-600 text-white">
                    <svg class="w-4 h-4 fill-current opacity-50 shrink-0" viewBox="0 0 16 16">
                        <path
                            d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z" />
                    </svg>
                    <span class="xs:block ml-2">Crear rol</span>
                </a>
        ...
        <div class="bg-white shadow-lg rounded-sm border border-slate-200">
            <header class="px-5 py-4">
                <h2 class="font-semibold text-slate-800">Todos los roles<span class="text-slate-400 font-medium">
                        <?php echo e($roles->count()); ?></span></h2>
            </header>
                                        ...
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                            <div class="flex items-center">
                                                <label class="inline-flex">
                                                    ...
                                                    <input class="table-item form-checkbox" value=<?php echo e($role->id); ?>
                                        ...
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="font-medium text-slate-800">
                                                    <?php echo e(Str::limit($role->name, 25)); ?>
        ...
        <script>
                    ...
                    selectAction() {
                        ...
                        if (checkboxes.length > 0) {
                            ...
                            checkboxes.forEach(function(check) {
                                rolesToDelete.push(check.value);
                            });
                        } else {
            ...
            async function deleteRoles() {
                ...
                data.append('roles', rolesToDelete);
                let token = document.head.querySelector('meta[name="csrf-token"]').content;
                try {
                    let url = 'http://blckweb.test/api/roles/delete';
...
<div class="flex w-full justify-between items-start">
    <div class="flex">
        ...
        <div>El rol o los roles se han eliminado correctamente. Recargando la pagina...</div>
    </div>
    <button class="opacity-70 hover:opacity-80 ml-3 mt-[3px]" @click="open = false">
        <div class="sr-only">Close</div>
        <svg class="w-4 h-4 fill-current">
...
<?php /**PATH C:\laragon\www\blckweb\resources\views/livewire/role-list.blade.php ENDPATH**/ ?>