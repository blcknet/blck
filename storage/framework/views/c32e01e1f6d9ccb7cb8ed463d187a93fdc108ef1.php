    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Posts</h1>
            </div>
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                <div class="relative">
                    <label for="action-search" class="sr-only">Buscar post</label>
                ...
                <!-- Add customer button -->
                <a href="<?php echo e(route('posts.create')); ?>" class="btn bg-indigo-500 hover:bg-indigo-600 text-white">
                    <svg class="w-4 h-4 fill-current opacity-50 shrink-0" viewBox="0 0 16 16">
                        <path
                            d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z" />
                    </svg>
                    <span class="xs:block ml-2">Crear post</span>
                </a>
        ...
        <div class="bg-white shadow-lg rounded-sm border border-slate-200">
            <header class="px-5 py-4">
                <h2 class="font-semibold text-slate-800">Todos los posts <span
                        class="text-slate-400 font-medium"><?php echo e($posts->count()); ?></span></h2>
            </header>
                        ...
                        <table class="table-auto w-full">
                            ...
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                        <div class="font-semibold text-left">Extracto</div>
                                    </th>
                                    <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                        <div class="font-semibold text-left">Contenido</div>
                                    </th>
                                    <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                        ...
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                            <div class="flex items-center">
                                                <label class="inline-flex">
                                                    ...
                                                    <input class="table-item form-checkbox" value=<?php echo e($post->id); ?>
                                        ...
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="font-medium text-slate-800">
                                                    <?php echo e(Str::limit($post->name, 25)); ?>

                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                            <div class="text-left"><?php echo e(Str::limit($post->extract, 25)); ?></div>
                                        </td>
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                            <div class="text-left"><?php echo Str::limit($post->body, 25); ?></div>
                                        </td>
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                            <div class="text-center">
                                                <?php if($post->status == 1): ?>
                                                    <div
                                                        class="text-sm inline-flex font-medium bg-emerald-100 text-emerald-600 rounded-full text-center px-2.5 py-1">
                                                        Publicado</div>
                                                <?php else: ?>
                                                    <div
                                                        class="text-sm inline-flex font-medium bg-red-100 text-red-600 rounded-full text-center px-2.5 py-1">
                                                        Borrador</div>
                                                <?php endif; ?>
                                            </div>
                                        </td>
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                            <div class="text-left font-medium text-sky-500">
                                                <?php if(isset($post->category->name)): ?>
                                                    <?php echo e(Str::limit($post->category->name, 10)); ?>
        ...
        <script>
                    ...
                    selectAction() {
                        ...
                        if (checkboxes.length > 0) {
                            ...
                            checkboxes.forEach(function(check) {
                                postsToDelete.push(check.value);
                            });
                        } else {
            ...
            async function deletePosts() {
                ...
                data.append('posts', postsToDelete);
                let token = document.head.querySelector('meta[name="csrf-token"]').content;
                try {
                    let url = 'http://blckweb.test/api/posts/delete';
                ...
                <div class="px-4 py-2 rounded-sm text-sm bg-emerald-100 border border-emerald-200 text-emerald-600">
                    <div class="flex w-full justify-between items-start">
                        <div class="flex">
                            ...
                            <div>El o los posts se han eliminado correctamente. Recargando la pagina...</div>
                        </div>
                        <button class="opacity-70 hover:opacity-80 ml-3 mt-[3px]" @click="open = false">
                            <div class="sr-only">Close</div>
                            <svg class="w-4 h-4 fill-current">
...
<?php /**PATH C:\laragon\www\blckweb\resources\views/livewire/list-post.blade.php ENDPATH**/ ?>