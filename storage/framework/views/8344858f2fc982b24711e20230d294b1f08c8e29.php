    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Etiquetas</h1>
            </div>
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                <div class="relative">
                    <label for="action-search" class="sr-only">Buscar etiqueta</label>
                    <input wire:model="search" id="action-search" class="form-input pl-9 focus:border-slate-300"
                        type="search" placeholder="Buscar etiqueta" />
                ...
                <!-- Add customer button -->
                <a href="<?php echo e(route('tags.create')); ?>" class="btn bg-indigo-500 hover:bg-indigo-600 text-white">
                    <svg class="w-4 h-4 fill-current opacity-50 shrink-0" viewBox="0 0 16 16">
                        <path
                            d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z" />
                    </svg>
                    <span class="xs:block ml-2">Crear etiqueta</span>
                </a>
        ...
        <div class="bg-white shadow-lg rounded-sm border border-slate-200">
            <header class="px-5 py-4">
                <h2 class="font-semibold text-slate-800">Todas las etiquetas <span
                        class="text-slate-400 font-medium"><?php echo e($tags->count()); ?></span></h2>
            </header>
                                ...
                                <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                            <div class="flex items-center">
                                                <label class="inline-flex">
                                                    ...
                                                    <input class="table-item form-checkbox" value=<?php echo e($tag->id); ?>
                                        ...
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="font-medium text-slate-800">
                                                    <?php echo e(Str::limit($tag->name, 25)); ?>
                                        ...
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="font-medium text-slate-800">
                                                    <?php echo e(Str::limit($tag->slug, 25)); ?>
        ...
        <script>
            ...
            async function deleteTags() {
                ...
                data.append('tags', tagsToDelete);
                let token = document.head.querySelector('meta[name="csrf-token"]').content;
                try {
                    let url = 'http://blckweb.test/api/tags/delete';
...
<div class="flex w-full justify-between items-start">
    <div class="flex">
        ...
        <div>La o las etiquetas se han eliminado correctamente. Recargando la página...</div>
    </div>
    <button class="opacity-70 hover:opacity-80 ml-3 mt-[3px]" @click="open = false">
        <div class="sr-only">Close</div>
        <svg class="w-4 h-4 fill-current">
...
<?php /**PATH C:\laragon\www\blckweb\resources\views/livewire/tag-list.blade.php ENDPATH**/ ?>