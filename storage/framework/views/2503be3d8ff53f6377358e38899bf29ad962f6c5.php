...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('head', null, []); ?> 
        ...
        <meta name="description"
            content="Servicios de desarrollo y diseño web que se adaptan a tus requerimientos. Desde una landing page, sitio informativo o tienda en línea hasta aplicaciones más personalizadas">
     <?php $__env->endSlot(); ?>

    <?php $__env->startSection('title', 'BLCKNet - Servicios'); ?>
    <!-- Page illustration -->
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            <div class="pt-32 pb-12 md:pt-40 md:pb-20">
                ...
                <div class="max-w-3xl mx-auto text-center pb-12">
                    <h1 class="h1 mb-4" data-aos="fade-up">Confiabilidad, calidad y precios transparentes.</h1>
                    <p class="text-xl text-gray-400" data-aos="fade-up" data-aos-delay="200">Si necesites una
                        Landing Page, un Sitio Informativo o una Tienda en Línea, te podemos ayudar.</p>
                </div>
                ...
                <div x-data="pricingSwitch">
                    ...
                    <div class="flex justify-center mb-16" data-aos="fade-up" data-aos-delay="400">
                        <div class="inline-flex items-center">
                            <div class="text-gray-500 font-medium mr-3">MXN.</div>
                            <div class="form-switch">
                                <input type="checkbox" name="pricing-toggle" id="pricing-toggle" class="sr-only"
                                    x-model="value" />
                            ...
                            <div class="text-gray-500 font-medium ml-3">USD.</div>
                        </div>
                    </div>
                    ...
                    <div class="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
                        ...
                        <!-- Pricing table 1 -->
                        <div class="pricing relative flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up"
                            data-aos-delay="700">
                            <div class="mb-4 pb-4 border-b border-gray-700">
                                <div class="h4 text-cyan-600 mb-1">Landing Page</div>
                                <div class="inline-flex items-baseline mb-2">
                                    <span x-text="priceOutput.plan1[value][0]"
                                        class="text-2xl md:text-3xl font-medium text-gray-400"></span>
                                    <span x-text="priceOutput.plan1[value][1]" class="h2"></span>
                                    <span x-text="priceOutput.plan1[value][2]" class="font-medium text-gray-400"></span>
                                </div>
                                <div class="text-gray-400">Página única con diseño elegante para mostrar tu información
                                    y servicios.</div>
                            </div>
                            <div class="font-medium mb-3">Caracteristicas incluidas:</div>
                            <ul class="text-gray-400 -mb-3 grow">
                                <li class="flex items-center mb-3">
                                    <svg class="w-3 h-3 fill-current text-green-500 mr-3 shrink-0" viewBox="0 0 12 12"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <li class="flex items-center mb-3">
                                    ...
                                    <span>Seguridad gratis por 1 año.</span>
                                </li>
                                <li class="flex items-center mb-3">
                                    <svg class="w-3 h-3 fill-current text-green-500 mr-3 shrink-0" viewBox="0 0 12 12"
                                        xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="flex items-center mb-3">
                                    ...
                                    <span>Imágenes sin copyright.</span>
                                </li>
                                <li class="flex items-center mb-3">
                                    <svg class="w-3 h-3 fill-current text-green-500 mr-3 shrink-0" viewBox="0 0 12 12"
                                        xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="border border-gray-700 p-3 mt-6">
                                <a class="btn-sm text-white bg-cyan-500 hover:bg-cyan-600 w-full"
                                    href="https://api.whatsapp.com/send?phone=525523215790&text=Hola,%20estoy%20interesado(a)%20en%20una%20Landing%20Page."
                                    rel="nofollow" target="_blank">Contactar</a>
                            </div>
                        </div>
                        ...
                        <div class="pricing relative flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up"
                            ...
                            <div class="mb-4 pb-4 border-b border-gray-700">
                                <div class="h4 text-cyan-600 mb-1">Sitio Informativo</div>
                                <div class="inline-flex items-baseline mb-2">
                                    <span x-text="priceOutput.plan2[value][0]"
                                        class="text-2xl md:text-3xl font-medium text-gray-400"></span>
                                    <span x-text="priceOutput.plan2[value][1]" class="h2"></span>
                                    <span x-text="priceOutput.plan2[value][2]"
                                        class="font-medium text-gray-400"></span>
                                </div>
                                <div class="text-gray-400">Sitio web con hasta 5 secciones + Blog administrable.</div>
                            </div>
                            <div class="font-medium mb-3">Todas las caracteristicas de Landing Page más:</div>
                            <ul class="text-gray-400 -mb-3 grow">
                                <li class="flex items-center mb-3">
                                    <svg class="w-3 h-3 fill-current text-green-500 mr-3 shrink-0" viewBox="0 0 12 12"
                                        xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="border border-gray-700 p-3 mt-6">
                                <a class="btn-sm text-white bg-cyan-500 hover:bg-cyan-600 w-full"
                                    href="https://api.whatsapp.com/send?phone=525523215790&text=Hola,%20estoy%20interesado(a)%20en%20un%20sitio%20informativo."
                                    rel="nofollow" target="_blank">Contactar</a>
                            </div>
                        </div>
                        ...
                        <div class="pricing relative flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up"
                            data-aos-delay="800">
                            <div class="mb-4 pb-4 border-b border-gray-700">
                                <div class="h4 text-cyan-600 mb-1">Tienda en Línea</div>
                                <div class="inline-flex items-baseline mb-2">
                                    <span x-text="priceOutput.plan3[value][0]"
                                        class="text-2xl md:text-3xl font-medium text-gray-400"></span>
                                    <span x-text="priceOutput.plan3[value][1]" class="h2"></span>
                                    <span x-text="priceOutput.plan3[value][2]"
                                        class="font-medium text-gray-400"></span>
                                </div>
                                <div class="text-gray-400">Ofrece tus servicios o productos en tu Tienda en línea.
                                </div>
                            </div>
                            <div class="font-medium mb-3">Todas las caracteristicas de Landing Page más:</div>
                            <ul class="text-gray-400 -mb-3 grow">
                                <li class="flex items-center mb-3">
                                    ...
                                    <span>Página para mostrar tus productos.</span>
                                </li>
                                <li class="flex items-center mb-3">
                                    <svg class="w-3 h-3 fill-current text-green-500 mr-3 shrink-0" viewBox="0 0 12 12"
                                        xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="flex items-center mb-3">
                                    ...
                                    <span>Carga de 15 productos.</span>
                                </li>
                            </ul>
                            <div class="border border-gray-700 p-3 mt-6">
                                <a class="btn-sm text-white bg-cyan-500 hover:bg-cyan-600 w-full"
                                    href="https://api.whatsapp.com/send?phone=525523215790&text=Hola,%20estoy%20interesado(a)%20en%20una%20tienda%20en%20línea."
                                    rel="nofollow" target="_blank">Contactar</a>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div class="font-medium text-sm text-center lg:text-left text-gray-400 mb-4 lg:mb-0">*El tiempo
                            de entrega y
                            la renovación anual
                            pueden variar.</div>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            <div class="py-12 md:py-20 border-t border-gray-800 lg:border-0 lg:pt-0">
                ...
                <ul class="grid gap-8 md:grid-cols-2 xl:gap-x-16 lg:gap-y-12">
                    <li>
                        <h4 class="text-xl font-medium mb-2">¿Cuanto cuesta la renovación anual?</h4>
                        <p class="text-lg text-gray-400">La renovación anual puede variar dependiendo el paquete
                            elegido.
                        </p>
                        <ul class="text-gray-500 leading-6 mt-3">
                            <li>Landing page: 799.00 mxn.</li>
                            <li>Sitio informativo: 1,199.00 mxn.</li>
                            <li>Academia o tienda en línea: 4,999.00 mxn.</li>
                        </ul>
                    </li>
                    <li>
                        <h4 class="text-xl font-medium mb-2">¿Ofrecen algún servicio de mantenimiento?</h4>
                        <p class="text-lg text-gray-400">Todos los paquetes incluyen 1 mes de mantenimiento y
                            cambios gratis.</p>
                        <small class="mt-3 block text-cyan-600">*Si desea contratar mantenimiento por 1 año:</small>
                        <ul class="text-gray-500 leading-6 mt-3">
                            <li>Landing page mantenimiento y cambios: 499.00 mxn.</li>
                            <li>Sitio informativo mantenimiento y cambios: 999.00 mxn.</li>
                            <li>Academia o tienda en línea mantenimiento y cambios: 1,499.00 mxn.</li>
                        </ul>

                        <small class="text-gray-400 mt-3 block">*Hasta 10 cambios mensules.</small>

                    </li>
                    <li>
                        <h4 class="text-xl font-medium mb-2">¿Ofrecen algún servicio de creación de contenido?</h4>
                        <p class="text-lg text-gray-400">Si, podemos crear todo el contenido de tu sitio web
                            proporcionando textos e imágenes sin derechos de autor. El precio es variable.</p>
                    </li>
                    <li>
                        <h4 class="text-xl font-medium mb-2">¿Hacen desarrollo web a medida?</h4>
                        <p class="text-lg text-gray-400">Si, podemos crear una aplicación web completamente a medida y
                            diseñada para ti.
                            El tiempo y precio final pueden aumentar.</p>
                    </li>
                    <li>
                        <h4 class="text-xl font-medium mb-2">¿Que es SEO?</h4>
                        <p class="text-lg text-gray-400">Son las siglas para (Search Engine Optmization) que no es más
                            que la optimización que se le da a tu sitio web para que pueda ser fácilmente rastreado por
                            Google y otros motores de búsqueda. Esto con el fin de aparecer en las primeras listas de
                            búsqueda.</p>
                    </li>
                    <li>
                        <h4 class="text-xl font-medium mb-2">¿Ofrecen pago a plazos?</h4>
                        <p class="text-lg text-gray-400">Si, con un plazo máximo de 3 meses. El primer pago se realiza
                            antes de publicar la web en internet. (Transferencia bancaria).
                        </p>
                    </li>
                </ul>
            </div>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            <div class="py-12 md:py-20 border-t border-gray-800">
                ...
                <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                    ...
                    <p class="text-xl text-gray-400">Vitae aliquet nec ullamcorper sit amet risus nullam eget felis
                ...
                <div class="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
                    ...
                    <div class="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up">
                        <div>
                            <div class="relative inline-flex flex-col mb-4">
                                <img class="rounded-full" src="./images/testimonial-01.jpg" width="48"
                                    height="48" alt="Testimonial 01" />
                                <svg class="absolute top-0 right-0 -mr-3 w-6 h-5 fill-current text-cyan-600"
                        ...
                        <blockquote class="text-lg text-gray-400 grow">— Open PRO lets me quickly get the insights I
                            care about so that I can focus on my productive work. I've had Open PRO for about 24 hours
                            now and I honestly don't know how I functioned without it before.</blockquote>
                        <div class="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                            <cite class="text-gray-200 not-italic">Anastasia Dan</cite> - <a
                                class="text-cyan-600 hover:text-gray-200 transition duration-150 ease-in-out">UX
                                Board</a>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up" data-aos-delay="200">
                        <div>
                            <div class="relative inline-flex flex-col mb-4">
                                <img class="rounded-full" src="./images/testimonial-02.jpg" width="48"
                                    height="48" alt="Testimonial 02" />
                                <svg class="absolute top-0 right-0 -mr-3 w-6 h-5 fill-current text-cyan-600"
                                    viewBox="0 0 24 20" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M0 13.517c0-2.346.611-4.774 1.833-7.283C3.056 3.726 4.733 1.648 6.865 0L11 2.696C9.726 4.393 8.777 6.109 8.152 7.844c-.624 1.735-.936 3.589-.936 5.56v4.644H0v-4.531zm13 0c0-2.346.611-4.774 1.833-7.283 1.223-2.508 2.9-4.586 5.032-6.234L24 2.696c-1.274 1.697-2.223 3.413-2.848 5.148-.624 1.735-.936 3.589-.936 5.56v4.644H13v-4.531z" />
                    ...
                    <div class="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up" data-aos-delay="400">
                        <div>
                            <div class="relative inline-flex flex-col mb-4">
                                <img class="rounded-full" src="./images/testimonial-03.jpg" width="48"
                                    height="48" alt="Testimonial 03" />
                                <svg class="absolute top-0 right-0 -mr-3 w-6 h-5 fill-current text-cyan-600"
                                    viewBox="0 0 24 20" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M0 13.517c0-2.346.611-4.774 1.833-7.283C3.056 3.726 4.733 1.648 6.865 0L11 2.696C9.726 4.393 8.777 6.109 8.152 7.844c-.624 1.735-.936 3.589-.936 5.56v4.644H0v-4.531zm13 0c0-2.346.611-4.774 1.833-7.283 1.223-2.508 2.9-4.586 5.032-6.234L24 2.696c-1.274 1.697-2.223 3.413-2.848 5.148-.624 1.735-.936 3.589-.936 5.56v4.644H13v-4.531z" />
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 relative">
            <div class="pt-12 md:pt-20 border-t border-b border-gray-800">
                <div class="max-w-3xl mx-auto text-center pb-12 md:pb-16" data-aos-id-cta>
                    ...
                    <!-- Section header -->
                    <h1 class="h2 mb-4" data-aos="fade-up" data-aos-anchor="[data-aos-id-cta]">¿Listo para dejar tu
                        marca en internet?</h1>
                    <p class="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200"
                        data-aos-anchor="[data-aos-id-cta]">Contáctanos vía whatsapp y en breve responderemos tu
                        mensaje. También puedes contactarnos vía <a class="text-cyan-500"
                            href="mailto:contacto@blcknet.com?Subject=Cotización%20Sitio%20Web"
                            rel="nofollow">e-mail</a></p>

                    <!-- CTA button -->
                    <div class="flex justify-center mb-8" data-aos="fade-up" data-aos-delay="400"
                        data-aos-anchor="[data-aos-id-cta]">
                        <a class="btn text-white bg-cyan-600 hover:bg-cyan-700"
                    ...
                    <ul class="flex flex-wrap justify-center text-lg text-gray-400 -mx-2 -my-1">
                        <li class="flex items-center mx-3 my-1" data-aos="fade-up" data-aos-delay="600"
                            data-aos-anchor="[data-aos-id-cta]">
                            ...
                            <span>Garantia de satisfacción.</span>
                        </li>
                        <li class="flex items-center mx-3 my-1" data-aos="fade-up" data-aos-delay="800"
                            data-aos-anchor="[data-aos-id-cta]">
                            <svg class="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <li class="flex items-center mx-3 my-1" data-aos="fade-up" data-aos-delay="1000"
                            data-aos-anchor="[data-aos-id-cta]">
                            <svg class="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\blckweb\resources\views/home/services.blade.php ENDPATH**/ ?>