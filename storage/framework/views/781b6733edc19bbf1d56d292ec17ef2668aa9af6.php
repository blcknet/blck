            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6">
                <div class="flex items-center justify-between h-20">
                    ...
                    <div class="shrink-0 mr-5">
                        <!-- Logo -->
                        <a class="block" href="<?php echo e(route('home.index')); ?>" aria-label="Cruip">
                            <img class="object-cover object-center h-16 w-16 rounded-full"
                                src="<?php echo e(asset('images/logo-blanco.png')); ?>" alt="">
                        </a>
                    </div>
                    <!-- Desktop navigation -->
                        ...
                        <div class="md:col-span-2 lg:col-span-3">
                            ...
                            <a class="inline-block" href="<?php echo e(route('home.index')); ?>" aria-label="Cruip">
                                <img id="logo-footer" class="h-36 w-36 object-center object-cover"
                                    src="<?php echo e(asset('images/logo-blanco.png')); ?>" alt="Logo largo blcknet">
                            </a>
                        </div>
...
<?php /**PATH C:\laragon\www\blckweb\resources\views/layouts/auth.blade.php ENDPATH**/ ?>