...
<?php $component->withAttributes([]); ?>
    ...
    <?php $__env->startSection('title', 'BLCKNet - Nosotros'); ?>
    <!-- Hero -->
                ...
                <div class="text-center">
                    <div class="relative flex justify-center items-center">
                        <div class="relative inline-flex items-start" data-aos="fade-up">
                            <img class="opacity-50" src="<?php echo e(asset('images/about-hero.jpg')); ?>" width="768"
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            <div class="pt-6 pb-12 md:pt-8 md:pb-20">
                ...
                <div class="grid grid-cols-12 gap-3 mt-12 md:mt-20" data-aos-id-gallery>
                    <img class="col-span-4" src="<?php echo e(asset('images/about-grid-01.jpg')); ?>" width="360" height="270"
                        alt="About grid 01" data-aos="fade-down" data-aos-anchor="[data-aos-id-gallery]" />
                    <img class="col-span-3" src="<?php echo e(asset('images/about-grid-02.jpg')); ?>" width="270" height="270"
                        alt="About grid 02" data-aos="fade-down" data-aos-anchor="[data-aos-id-gallery]"
                        data-aos-delay="100" />
                    <img class="col-span-5" src="<?php echo e(asset('images/about-grid-03.jpg')); ?>" width="450"
                        height="270" alt="About grid 03" data-aos="fade-down"
                        data-aos-anchor="[data-aos-id-gallery]" data-aos-delay="200" />
                    <img class="col-span-3" src="<?php echo e(asset('images/about-grid-04.jpg')); ?>" width="270"
                        height="270" alt="About grid 04" data-aos="fade-down"
                        data-aos-anchor="[data-aos-id-gallery]" data-aos-delay="300" />
                    <img class="col-span-5" src="<?php echo e(asset('images/about-grid-05.jpg')); ?>" width="450"
                        height="270" alt="About grid 05" data-aos="fade-down"
                        data-aos-anchor="[data-aos-id-gallery]" data-aos-delay="400" />
                    <img class="col-span-4" src="<?php echo e(asset('images/about-grid-06.jpg')); ?>" width="360"
                    ...
                    <div class="flex flex-wrap justify-center -m-5 lg:-my-7" data-aos-id-team>
                        ...
                        <div class="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 p-5 lg:py-7" data-aos="fade-down"
                            ...
                            <div class="flex flex-col items-center">
                                <img class="rounded-full mb-2" src="<?php echo e(asset('images/team-member-01.jpg')); ?>"
                        ...
                        <div class="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 p-5 lg:py-7" data-aos="fade-down"
                            ...
                            <div class="flex flex-col items-center">
                                <img class="rounded-full mb-2" src="<?php echo e(asset('images/team-member-02.jpg')); ?>"
                        ...
                        <div class="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 p-5 lg:py-7" data-aos="fade-down"
                            ...
                            <div class="flex flex-col items-center">
                                <img class="rounded-full mb-2" src="<?php echo e(asset('images/team-member-03.jpg')); ?>"
                        ...
                        <div class="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 p-5 lg:py-7" data-aos="fade-down"
                            ...
                            <div class="flex flex-col items-center">
                                <img class="rounded-full mb-2" src="<?php echo e(asset('images/team-member-04.jpg')); ?>"
                        ...
                        <div class="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 p-5 lg:py-7" data-aos="fade-down"
                            ...
                            <div class="flex flex-col items-center">
                                <img class="rounded-full mb-2" src="<?php echo e(asset('images/team-member-05.jpg')); ?>"
                        ...
                        <div class="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 p-5 lg:py-7" data-aos="fade-down"
                            ...
                            <div class="flex flex-col items-center">
                                <img class="rounded-full mb-2" src="<?php echo e(asset('images/team-member-06.jpg')); ?>"
                        ...
                        <div class="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 p-5 lg:py-7" data-aos="fade-down"
                            ...
                            <div class="flex flex-col items-center">
                                <img class="rounded-full mb-2" src="<?php echo e(asset('images/team-member-07.jpg')); ?>"
                        ...
                        <div class="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 p-5 lg:py-7" data-aos="fade-down"
                            ...
                            <div class="flex flex-col items-center">
                                <img class="rounded-full mb-2" src="<?php echo e(asset('images/team-member-08.jpg')); ?>"
                        ...
                        <div class="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 p-5 lg:py-7" data-aos="fade-down"
                            data-aos-delay="600" data-aos-anchor="[data-aos-id-team]">
                            <div class="flex flex-col items-center">
                                <img class="rounded-full mb-2" src="<?php echo e(asset('images/team-member-09.jpg')); ?>"
                        ...
                        <div class="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 p-5 lg:py-7" data-aos="fade-down"
                            data-aos-delay="700" data-aos-anchor="[data-aos-id-team]">
                            <div class="flex flex-col items-center">
                                <img class="rounded-full mb-2" src="<?php echo e(asset('images/team-member-10.jpg')); ?>"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\blckweb\resources\views/home/about.blade.php ENDPATH**/ ?>